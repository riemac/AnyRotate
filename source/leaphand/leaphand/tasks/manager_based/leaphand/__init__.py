...
from .inhand_env_v2_cfg import InHandEnvV2Cfg
...
gym.register(
    id="Template-InHand-Manager-v1", # [项目名]-[任务名]-[架构名]-v[版本号]
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Template-InHand-Manager-v2", # [项目名]-[任务名]-[架构名]-v[版本号]
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.inhand_env_v2_cfg:InHandEnvV2Cfg", # 包路径.模块名:类名
        "rl_games_cfg_entry_point": f"{agents.__name__}:rl_games_ppo_inhand_v2_cfg.yaml",
    }
)